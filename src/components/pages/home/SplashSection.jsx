  ...
  return (
    <div className="relative">
      <img
        src={img}
        alt=""
        className="w-screen h-[60vh] md:h-[80vh] lg:h-screen  object-cover z-0 absolute"
      />
      <div className="relative w-screen h-[60vh] md:h-[80vh] lg:h-screen gap-10 md:gap-20 flex flex-col  items-center justify-end">
        ...
        <img src={imgVector} alt="" className="w-screen  object-cover  z-40 " />
      </div>
    </div>
  );
}

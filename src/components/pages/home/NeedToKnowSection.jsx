        ...
        <>
            <section className="container">
                <div className="px-[2rem] md:px-[4.5rem]">
                    <h1 className="text-[2.3rem] mb-[3rem] text-[5.625rem] font-[500] text-[#00A991] reenie-beanie">You need to know these</h1>
                    <div className=" flex flex-col md:flex-row gap-[2.5rem]">
                        ...
                        <div id="blog-carousel" className="flex flex-col gap-[2.5rem]   md:w-[60%]">
                    ...
                    <div className="flex justify-end gap-5 py-5">
                        <div className="rounded-[0.25rem] p-5 bg-[#00A991] cursor-pointer" onClick={prevSlide}>
                            <img src="/left_keyboard_backspace.svg" alt="" />
                        </div>
                        <div className="rounded-[0.25rem] p-5 bg-[#00A991] cursor-pointer" onClick={nextSlide}>

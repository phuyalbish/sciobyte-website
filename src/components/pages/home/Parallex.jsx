    ...
    <div className="relative m-0 p-0 w-full h-[150vh] overflow-hidden">
      <div className="w-full overflow-hidden">
        <motion.img
          src={img1}
          alt=""
          className="absolute z-40 md:min-w-[100vw]"
      ...
      <div className="w-full overflow-hidden">
        <motion.img
          src={img2}
          alt=""
          className="absolute z-30 md:min-w-[100vw]"
      ...
      <div className="w-full overflow-hidden">
        <motion.img
          src={img3}
          alt=""
          className="absolute z-20 min-w-[100vw]"
      ...
      <div className="w-full overflow-hidden">
        <motion.img
          src={img5}
          alt=""
          className="absolute z-10 min-w-[100vw]"
      ...
      <div className="w-full overflow-hidden">
        <motion.img
          src={img8}
          alt=""
          className="absolute -z-0 min-w-[100vw]"

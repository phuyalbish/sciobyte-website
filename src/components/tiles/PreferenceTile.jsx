...
function PreferenceTIle({ img, name, slug }) {
  return (
    <Link to={slug}  className="w-full overflow-hidden relative md:max-w-[250px] aspect-square  cursor-pointer shadow-lg md:shadow-none m-2 hover:shadow-lg transition-all duration-300 ease-in-out rounded-md flex flex-col gap-3 bg-white">
